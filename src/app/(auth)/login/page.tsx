...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setErrorMessage(
        err?.message ||
          'Não foi possível autenticar com o Google no momento. Verifique a configuração no painel do Supabase.'
      )
    ...
    try {
      ...
      setErrorMessage(
        err?.message === 'Invalid login credentials'
          ...
          : err?.message || 'Falha ao autenticar. Tente novamente.'
      )
    } finally {
      setIsLoading(false)
    }
  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        {/* Botão Google OAuth em destaque */}
        <button
        ...
        <form className={styles.form} id="login-form" onSubmit={handleEmailLogin}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              required
            />
            <Link href="#" className={styles.forgot} onClick={e => { e.preventDefault(); alert('Em breve recuperação de senha via e-mail.') }}>
              Esqueceu a senha?
            </Link>
          </div>
