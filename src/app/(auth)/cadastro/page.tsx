  ...
  return (
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <form className={styles.form} id="cadastro-form">
          <div className="form-group">
            <label className="form-label" htmlFor="cadastro-name">Nome completo</label>
            <input id="cadastro-name" type="text" className="form-input" placeholder="Seu nome" autoComplete="name" required />
          </div>

          <div className="form-group">
            <label className="form-label" htmlFor="cadastro-email">E-mail</label>
            <input id="cadastro-email" type="email" className="form-input" placeholder="seu@email.com" autoComplete="email" required />
          </div>

          <div className="form-group">
            <label className="form-label" htmlFor="cadastro-password">Senha</label>
            <input id="cadastro-password" type="password" className="form-input" placeholder="Mínimo 8 caracteres" autoComplete="new-password" required />
          </div>

          <div className="form-group">
            <label className="form-label" htmlFor="cadastro-surname">Sobrenome familiar</label>
            <input id="cadastro-surname" type="text" className="form-input" placeholder="Ex: Ferraro, Silva, Costa..." />
            <span className={styles.fieldHint}>Opcional — para iniciar sua família</span>
          </div>

          <div className={styles.terms}>
            <input id="terms-check" type="checkbox" className={styles.checkbox} required />
          ...
          <Link href="/dashboard" className={`btn btn-primary btn-full btn-lg ${styles.submitBtn}`} id="cadastro-btn">
        ...
        <button className={`btn btn-ghost btn-full ${styles.oauthBtn}`} id="google-signup-btn" type="button">
